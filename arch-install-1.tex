...
\begin{document}
  ...
  \begin{frame}
    ...
    \note{ユーザーの要件を満たすようなソフトウェアを開発することを考えます。ハードウェアを1つに固定することができれば問題はないです。しかし、動作させてみてから、要件が変更になることもあります。ハードウェアを変更することで対応できたりします。例えば、A社のマザーボードより、B社のマザーボードの方がメモリスロットがたくさんあって、B社のマザーボードに変更して、大容量メモリで動作させたいとか...。}
  \end{frame}
